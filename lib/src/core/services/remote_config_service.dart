  ...
  Future<RemoteConfigService> init() async {
    ...
    try {
      ...
      await _remoteConfig.setDefaults(const {
        ...
        'irllink_refresh_token_url': 'https://dev.irllink.com/api/twitch-refresh-token',
        'irllink_refresh_token_url_dev': 'https://irllink.com/api/twitch-refresh-token',
        'irllink_refresh_se_token_url': 'https://dev.irllink.com/api/streamelements/refresh-token',
        'irllink_refresh_se_token_url_dev': 'https://dev.irllink.com/api/streamelements/refresh-token',
        ...
        'irllink_kick_refresh_token_url': 'https://irllink.com/api/kick/refresh-token',
        'irllink_kick_refresh_token_url_dev': 'https://dev.irllink.com/api/kick/refresh-token',
        'verify_android_purchase': 'https://www.irllink.com/api/verify-android-purchase',
        'verify_android_purchase_dev': 'https://dev.irllink.com/api/verify-android-purchase',
        'verify_ios_purchase': 'https://www.irllink.com/api/verify-ios-purchase',
        'verify_ios_purchase_dev': 'https://dev.irllink.com/api/verify-ios-purchase',
