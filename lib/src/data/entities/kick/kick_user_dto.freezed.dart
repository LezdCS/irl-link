...
/// Adds pattern-matching-related methods to [KickUserDTO].
extension KickUserDTOPatterns on KickUserDTO {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_KickUserDTO value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _KickUserDTO() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _KickUserDTO() when $default != null:
        return $default(
            _that.userId, _that.name, _that.email, _that.profilePicture);
      case _:
        return orElse();
    }
  }
