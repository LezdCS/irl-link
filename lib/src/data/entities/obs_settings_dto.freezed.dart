...
/// Adds pattern-matching-related methods to [ObsSettingsDTO].
extension ObsSettingsDTOPatterns on ObsSettingsDTO {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ObsSettingsDTO value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ObsSettingsDTO() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String url, String password,
            @JsonKey(name: 'is_connected') bool isConnected)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ObsSettingsDTO() when $default != null:
        return $default(_that.url, _that.password, _that.isConnected);
      case _:
        return orElse();
    }
  }
