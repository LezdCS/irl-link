...
/// Adds pattern-matching-related methods to [TwitchHypeTrainDTO].
extension TwitchHypeTrainDTOPatterns on TwitchHypeTrainDTO {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TwitchHypeTrainDTO value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _TwitchHypeTrainDTO() when $default != null:
    ...
    switch (_that) {
      case _TwitchHypeTrainDTO() when $default != null:
        return $default(
            ...
            _that.goal,
            _that.level,
            _that.topContributions,
            _that.lastContribution,
            _that.endsAt);
      case _:
        return orElse();
    }
...
/// Adds pattern-matching-related methods to [ContributionDTO].
extension ContributionDTOPatterns on ContributionDTO {
  /// A variant of `map` that fallback to returning `orElse`.
  ///
  /// It is equivalent to doing:
  /// ```dart
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ContributionDTO value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ContributionDTO() when $default != null:
        return $default(_that);
      case _:
        return orElse();
    }
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ContributionDTO() when $default != null:
        return $default(_that.userId, _that.userLogin, _that.userName,
            _that.type, _that.total);
      case _:
        return orElse();
    }
  }
