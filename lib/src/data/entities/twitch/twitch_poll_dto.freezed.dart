...
/// Adds pattern-matching-related methods to [TwitchPollDTO].
extension TwitchPollDTOPatterns on TwitchPollDTO {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TwitchPollDTO value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _TwitchPollDTO() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String title, List<ChoiceDTO> choices,
            int totalVotes, PollStatus status, DateTime endsAt)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _TwitchPollDTO() when $default != null:
        return $default(_that.id, _that.title, _that.choices, _that.totalVotes,
            _that.status, _that.endsAt);
      case _:
        return orElse();
    }
  }
...
/// Adds pattern-matching-related methods to [ChoiceDTO].
extension ChoiceDTOPatterns on ChoiceDTO {
  /// A variant of `map` that fallback to returning `orElse`.
  ///
  /// It is equivalent to doing:
  /// ```dart
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ChoiceDTO value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ChoiceDTO() when $default != null:
        return $default(_that);
      case _:
        return orElse();
    }
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String title, int votes)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ChoiceDTO() when $default != null:
        return $default(_that.id, _that.title, _that.votes);
      case _:
        return orElse();
    }
  }
