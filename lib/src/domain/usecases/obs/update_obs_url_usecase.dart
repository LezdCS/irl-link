...
class UpdateObsUrlUsecase extends UseCase<Either<Failure, void>, ObsSettings> {
  final SettingsRepository settingsRepository;

  UpdateObsUrlUsecase({required this.settingsRepository});

  @override
  Future<Either<Failure, void>> call({required ObsSettings params}) async {
    return settingsRepository.updateObsUrl(params);
  }
}
